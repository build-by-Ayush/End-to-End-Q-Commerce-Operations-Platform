...
def generate_operational_events(
    ...
    for fulfilment in fulfilment_units:
        ...
        order_created_at = parse_timestamp(
            order["created_at"]
        )
        ...
        if fulfilment["status"] == "CANCELLED":
            cancellation_time = (
                parse_timestamp(fulfilment["cancelled_at"])
            ...
            fulfilment["cancelled_at"] = format_timestamp(
                cancellation_time
            )
        ...
        if fulfilment["status"] == "FAILED":
            failure_time = (
                parse_timestamp(fulfilment["failed_at"])
        ...
        fulfilment["picking_started_at"] = (
            format_timestamp(picking_started_at)
        )

        fulfilment["picking_completed_at"] = (
            format_timestamp(picking_completed_at)
        )

        fulfilment["packing_started_at"] = (
            format_timestamp(packing_started_at)
        )

        fulfilment["packing_completed_at"] = (
            format_timestamp(packing_completed_at)
        )
        ...
        rider_assigned_at = parse_timestamp(
        ...
        delivery["rider_arrived_at_store"] = (
            format_timestamp(rider_arrived_at_store)
        )
        delivery["picked_up_at"] = (
            format_timestamp(picked_up_at)
        )
        delivery["delivery_started_at"] = (
            format_timestamp(delivery_started_at)
        )
